...
package com.sycamore.ticketing_system.log.core;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(com.sycamore.ticketing_system.log.annotation.ILog) || @annotation(com.sycamore.ticketing_system.log.annotation.ILog)")
