...
package com.sycamore.ticketing_system.web.initialize;
...
import static com.sycamore.ticketing_system.web.config.WebAutoConfiguration.INITIALIZE_PATH;
/**
...
public final class InitializeDispatcherServletHandler implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        String url = String.format("http://127.0.0.1:%s%s",
                ...
                INITIALIZE_PATH);
        try {
            log.info("Initializing DispatcherServlet..., url: {}", url);
