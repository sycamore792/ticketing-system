...
import com.sycamore.ticketing_system.base.init.ApplicationInitializingEvent;
 ...
 * @CLASS_NAME: AbstractStrategyChoose
 * @DESCRIPTION:
 * @CREATER: 桑运昌
...
public class AbstractStrategyChoose implements ApplicationListener<ApplicationInitializingEvent> {
    ...
    public void onApplicationEvent(ApplicationInitializingEvent event) {
        Map<String, AbstractExecuteStrategy> actual = ApplicationContextHolder.getBeans(AbstractExecuteStrategy.class);
